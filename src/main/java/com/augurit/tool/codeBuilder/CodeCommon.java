...
//        createCodeForJsFile(root);
    ...
    public String createTableNameDesc()  {
       String  sql_desc="";
        ...
        String tabledesc="";
        if (getTableNameDesc()!=null && !"".equals(getTableNameDesc().trim())){return getTableNameDesc();}
        ...
        try{
            ...
            while (resultset_stmt_rmark.next()) {
                ...
                if (resultset_stmt_rmark.getString("COLUMN_KEY")!=null && !"".equals(resultset_stmt_rmark.getString("COLUMN_KEY").trim())){
                    if("PRI".equals(resultset_stmt_rmark.getString("COLUMN_KEY").toUpperCase())) pk_columns.add(resultset_stmt_rmark.getString("COLUMN_NAME"));
                }
